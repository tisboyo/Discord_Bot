...
class lol(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if (
            ...
            or not Database.Cogs[self.name][message.guild.id]["settings"][
                "enabled"
            ]  # Not enabled
        ...
        if "lol" in message.content:
            ...
            if (
                len(Database.Cogs[self.name][message.guild.id][message.channel.id])
                >= threshold
            ):
            ...
            if Database.Cogs[self.name][message.guild.id].get(
                message.channel.id, False
            ):
                del Database.Cogs[self.name][message.guild.id][message.channel.id]
